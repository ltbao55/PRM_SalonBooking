...
2) UI StaffSchedule cơ bản (2–3h)
...
5) Cập nhật trạng thái ca làm (1–2h)
...
3) Chi tiết booking + đổi trạng thái (2–3h)
...
2) Firestore Security Rules (1–2h)
...
1) Loading/Empty/Error thống nhất
...
3) Kiểm thử thủ công toàn luồng
